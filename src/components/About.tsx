      ...
      <div className="mb-16 md:px-0 px-5">
        <div className="content">
          ...
          <div className="sub-content">
            <p>
              Every content we serve is a reflection of our obsession with
              detail -from the first muddle to the the final garnish. That care
              is what turns a simple drink to a something truly memorable.
            </p>
            <div>
